...
\begin{itemize}
  ...
  \item \textbf{R2 (Verifiability):} \textit{Partially satisfied (integrity and
    ...
    which is designed but not implemented. This is the single most important
...
\begin{itemize}
  ...
  \item \textbf{Self-reported data and a self-referential evidence hash:}
    ...
    is stronger but still self-referential to a self-reported log, and is untested:
    our 35 unit tests cover contract mechanics, not the off-chain
    serialization/hashing pipeline (\cref{subsec:prototype}).
