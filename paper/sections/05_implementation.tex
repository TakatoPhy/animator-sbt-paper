...
the repository adds a further 35 tests---17 for the v2 co-signing reference contract
(\cref{subsec:cosigning}), 7 for the canonical evidence-hash serialisation, 10 for
the disclosure commitment of \cref{subsec:privacy}, and a local end-to-end issuance test---for 70 passing in total.
